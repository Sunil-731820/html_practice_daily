 var billAmount = 0;
		...
		var restaurantArray = new Array("Ohris", "Chutneys", "Taj", "Banjara",
            "BBQ", "Paradise", "Kritunga", "Mefil","TAJHOTEL","INOX" ,"CROWN","TAMARA","HYAT");
var bg_image = new Array("url('images/rest.jpg')", "url('images/rest1.jpg')",
    ...
    "url('images/rest9.jpg')","url('images/rest10.jpg')","url('images/rest11.jpg')"
    ,"url('images/rest12.jpg')","url('images/rest13.jpg')");
		var tb_color = new Array("#00ff00", "Coral", "Crimson", "DeepPink", 
		"Tomato", "IndianRed", "Yellow", "OrangeRed","#00ff00", "Coral", "Crimson", "Tomato", "IndianRed",);
        var i = 0;
        ...
        menu[8][2] = "RAWADI";
        menu[8][3] = "FISH ";
        menu[8][4] = "CAULIFLOWER";
        menu[8][5] = "CABBAGE";
        menu[8][6] = "CARROT";
        menu[8][7] = "PEA";
        
        menu[9][0] = "Puri Bhaji";
        menu[9][1] = "Aloo Parantha";
        menu[9][2] = "Steamed Idli";
        menu[9][3] = "Medu Wada";
        menu[9][4] = "Sada Dosa";
        menu[9][5] = "Masala Dosa";
        menu[9][6] = "Uttappam";
        menu[9][7] = "Onion Rawa Masala Dosa";
        
		menu[10][0] = "DosaSpecial Banjara Paneer Kebab";
        menu[10][1] = "Tandoori Paneer Tikka";
        menu[10][2] = "Pahadi Paneer Tikka";
        menu[10][3] = "Atishi Tandoori Aloo";
        menu[10][4] = "Veg.Seekh Kebab";
        menu[10][5] = "Kurkure Bhindi";
        menu[10][6] = "Tandoori Corn";
        menu[10][7] = "Paneer Malai Tikka";
        
        
        
        menu[11][0] = "Veg Biryani";
        menu[11][1] = "Chiken Biryani";
        menu[11][2] = "Butter Nan";
        menu[11][3] = "Chiken 65";
        menu[11][4] = "Paneer Butter Masala";
        menu[11][5] = "Lolly Biryani";
        menu[11][6] = "Fry Peace Chicken Biryani";
        menu[11][7] = "Mutton Biryani";
        
        menu[12][0] = "Veg Biryani";
        menu[12][1] = "Chiken Biryani";
        menu[12][2] = "Butter Nan";
        menu[12][3] = "Chiken 65";
        menu[12][4] = "Paneer Butter Masala";
        menu[12][5] = "Lolly Biryani";
        menu[12][6] = "Fry Peace Chicken Biryani";
        menu[12][7] = "Mutton Biryani";
